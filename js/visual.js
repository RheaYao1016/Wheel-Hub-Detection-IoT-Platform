$(function () {
            ...
            series : [
                {
                    ...
                    data:[71, 31, 31,54, 50, 80, 10, 21, 4, 60, 50, 41,71, 32, 21,75, 50, 80, 10, 52, 54, 66, 53, 41]
                }
            ]
        };
        // 使用刚指定的配置项和数据显示图表。
    ...
    function echarts_5() {
        ...
        var xData = function() {
            var data = ['型号一','型号二','型号三','型号四','型号五'];

            return data;
        }();

        var data = [8, 12, 20, 16, 9]
    ...
    function echarts_6() {
        ...
        option = {
            ...
            tooltip: {
                ...
                formatter: function(params) {
                    return params[0]["data"].name + "<br/>" + '运行时长: ' + params[1]["data"].value+'h' ;
                }
            },
            xAxis: [{
                type: 'category',
    ...
    function echarts_8() {
        var myChart = echarts.init(document.getElementById('echarts_8'));
        var data = [
            {value: 40, name: 'A'},
        ];
        option = {
    ...
    function echarts_9() {
        var myChart = echarts.init(document.getElementById('echarts_9'));
