  ...
  return (
    <div className="page-shell pt-0 pb-10 space-y-6">
      ...
      <div className="flex flex-col gap-2">
        <span className="text-xs text-[var(--text-secondary)]">管理员后台 / 工件明细</span>
        <h1 className="text-2xl font-semibold text-white md:text-3xl">工件信息总览</h1>
        <p className="text-sm text-[var(--text-secondary)]">查看当前库工件规格与更新时间</p>
      </div>

      <Card>
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          <h2 className="text-lg font-semibold text-white">工件列表</h2>
